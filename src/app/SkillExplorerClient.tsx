// Client component: handles all interactive UI state
'use client';
...
interface SkillExplorerClientProps {
  initialSkills: Skill[];
  updatedAt: number;
}

export default function SkillExplorerClient({ initialSkills, updatedAt: serverUpdatedAt }: SkillExplorerClientProps) {
  ...
  const [lastUpdated, setLastUpdated] = useState<number | null>(serverUpdatedAt || null);
            ...
            <div>
              ...
              {lastUpdated && (
                <p className="text-zinc-600 text-xs">
                  ...
                  <span className="ml-2 text-zinc-700">(ISR: 24h revalidation)</span>
                </p>
              )}
            </div>
